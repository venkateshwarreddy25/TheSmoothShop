...
const Kitchendata = () => {
  const displayKitchen = kitchenData.slice(0, 5);

  return (
    <div className="container my-5">
      <h2 className="text-center fw-bold mb-4 text-primary">Kitchen Appliances</h2>

      <div className="row g-4">
        {displayKitchen.map((item) => (
          <div className="col-12 col-sm-6 col-md-4 col-lg-3 col-xl" key={item.id}>
            <div className="card shadow-sm border-0 h-100 hover-card">

              <Link to={`/kitchen/${item.id}`} className="text-decoration-none">
